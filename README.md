...
> [!IMPORTANT]
> **Multimodal Promptomatix Extensions**: We have added local-first image generation and visual evaluation capabilities to the prompt optimizer. For details on all new files, core modifications, and architectural memory configurations, please read the [DOCUMENTATION_ADDITIONS.md](DOCUMENTATION_ADDITIONS.md) file.
